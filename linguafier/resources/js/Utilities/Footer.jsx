...
return <>
    <footer className="bg-my-green90 flex justify-center pt-12 pb-8 md:px-8 px-4">
        <div className="flex lg:flex-nowrap flex-wrap gap-4 gap-x-8" style={{width:"90rem"}}>
            <div className="flex md:flex-nowrap flex-wrap gap-4 gap-x-8">
                ...
                <div className="grow w-full">
                    ...
                    <p className=" break-words text-slate-200 text-sm font-light text-justify">
                        Language is essential for communication, it allows us to express what we need to tell others. While proficiency is not required, there will be times we need to be better at it like writing love letters or debating on the internet. A single word may turn the tables upside down. The words we use can make an impact. Why words? When we learn a language we always start with a word . Introducing Linguafier, a web app that acts like a dictionary BUT with gamification elements such as Attributes (kinda like fire, ice and lightning), Variation (like a class in an RPG), and Rarity (like gacha). It also has a hierarchy map where you can see how it relates to other words. There are still other things to see in this app but I leave the rest to you. Have a nice day!
                    </p>
