    ...
    <main className='w-full h-screen flex justify-center items-center'>
        ...
        <form className='w-96 rounded-xl bg-my-light shadow-myBox5 overflow-hidden' onSubmit={submit}>
            ...
            <div className='mt-10 px-10'>
                ...
                <TextBox Handle={[v_username, e_username]} Size="w-full" Error={errors.v_username} PressFunc={""} Placeholder="Type here"/>

                <div className='py-2'></div>
                <label>State your <span className='text-my-green font-semibold'>Password</span> </label>
                <TextBox Type="password" Handle={[v_password, e_password]} Size="w-full" Error={errors.v_password} PressFunc={""} Placeholder="Type here"/>
            </div>
